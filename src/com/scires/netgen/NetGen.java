...
public class NetGen {
    ...
    private static String REGEX_THREE_HOST_IP_OCTETS =
            "\\b(25[0-4]|2[0-4]\\d|[01]?\\d\\d?)" +
                    ...
                    "\\.(25[0-4]|2[0-4]\\d|[01]?\\d\\d?)";
    static String REGEX_IP_GENERIC = REGEX_THREE_IP_OCTETS +"\\.(25[0-5]|2[0-4]\\d|[01]?\\d\\d?)\\b";
    static String REGEX_IP_GENERIC_LINE = ".*"+ REGEX_IP_GENERIC +".*";
    static String REGEX_IP_HOST = REGEX_THREE_HOST_IP_OCTETS + "\\.(25[0-4]|2[0-4]\\d||[1]\\d\\d|[1-9]\\d?)\\b";
    static String REGEX_IP_GATEWAY = REGEX_THREE_IP_OCTETS + "\\.0";
    static String REGEX_KEY_TIME =
            "(?:((?:\\d{2}:){2}\\d{2} " +
                    "(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) " +
                    "\\d{1,2} \\d{4}|infinite))";
    static String REGEX_COC_PWD = "(?=^.{15,}$)" +
            "(?=.*\\d.*\\d)" +
            "(?=.*[a-z].*[a-z])" +
            "(?=.*[A-Z].*[A-Z])" +
            "(?=.*[!@#$%^;*()_+}{&\":;'?/><].*[!@#$%^;*()_+}{&\":;'?/><])" +
            "(?!.*\\s).*$";
    static String REGEX_NOT_BLANK = ".{1,}$";
